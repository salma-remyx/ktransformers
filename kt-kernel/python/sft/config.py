...
class KTConfig:
    ...
    kt_approx_bp: bool | None = None  # ReSiLU2 backward for LoRA experts, saves activation memory
    ...
    def __post_init__(self):
        ...
        if self.kt_approx_bp is None:
            self.kt_approx_bp = _env_bool("ACCELERATE_KT_APPROX_BP", False)
